...
# ============================================================
# STREAMLIT CHATBOT – GROUP 10 (FULLY FIXED VERSION)
# ============================================================
...
# ============================================================
@st.cache_resource(show_spinner="Loading documents & building RAG system…")
def init_chatbot():
    ...
    for _, row in df_cifar.iterrows():
        text = f"""
CIFAR pillar analysis – {row['pillar']}
...
"""
    ...
    for _, row in df_comp.iterrows():
        text = f"""
Country competitiveness – {row['country']}:
...
"""
    ...
    for entry in strategy_data:
        text = f"""
AI Strategy Summary – {entry["country"]}
...
# input field
user_q = st.chat_input("Ask about Canada’s AI strategy…")
if user_q:
